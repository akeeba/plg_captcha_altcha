...
The generated package is under `altcha/release`.
...
> [!WARNING]
> Do not download the `plg_captcha_altcha.zip` file (without a version number). That's a file automatically generated by GitHub containing the source code in this repository. You cannot install this in Joomla!.
